      ...
      <div class="flex justify-between items-center px-6 sm:px-0">
        ...
        <div>
          <NuxtLink to="/">
           ...
           <h2 v-if="this.$colorMode.value == 'dark'" class='font-semibold text-white sm:text-lg lg:text-xl'>Yatachi code</h2>
           <h2 v-else class='font-semibold text-indigo-700 sm:text-lg lg:text-xl'>Yatachi code</h2>
          </NuxtLink>
        </div>
